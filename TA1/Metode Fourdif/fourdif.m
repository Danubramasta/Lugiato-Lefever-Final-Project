...
%
% [x, DM] = fourdif(N,m) computes the m'th derivative Fourier spectral
% differentiation matrix on grid with N equispaced points in [0,2pi)
% 
%  Input:
...
%  DM:       m'th order diffrentiation matrix
%
% 
